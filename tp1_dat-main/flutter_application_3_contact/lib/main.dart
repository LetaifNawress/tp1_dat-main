...
void main() {
  Contact contact1 = Contact(
      'bny', 'naw', 'sousse', 'naw@gmail.com', '+21696060494', '721234567');
  Contact contact2 =
      Contact.pro('sousou', 'sousou', 'sousou@gmail.com', '+216987654321');
...
class Contact {
  ...
  Contact(this.name, this.surname, this.address, this._email, this._mobileTel,
      this.homeTel);
